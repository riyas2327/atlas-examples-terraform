...
9. Make sure your VPC is setup correctly. If you have an AWS classic account or having an existing VPC setup, there are [some steps](../setup/vpc.md) you'll want to follow to make sure it is setup to allow Packer to work.
